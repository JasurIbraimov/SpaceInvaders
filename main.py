...
class Game(arcade.Window):
    def __init__(self, title):
        ...
        Explosion(-100, -100) # first explosion, to make animation work faster, to prevent cooldown after first enemy kill
